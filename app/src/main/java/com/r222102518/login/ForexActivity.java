...
public class ForexActivity extends AppCompatActivity {
    ...
    private void bindRecyclerView(){
        String ratesUrl = "https://openexchangerates.org/api/latest.json?app_id=4303d7b5e82848f0acf4c223303fe9a4";
        ...
        client.get(ratesUrl, new AsyncHttpResponseHandler() {
                    ...
                    client.get(currencyUrl, new AsyncHttpResponseHandler() {
                        ...
                        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                            try {
                                ...
                                _recyclerView1.setLayoutManager(new LinearLayoutManager(ForexActivity.this));
                                _recyclerView1.setAdapter(adapter);

                            } catch (JSONException e) {
                                Toast.makeText(ForexActivity.this, "Gagal parsing mata uang", Toast.LENGTH_SHORT).show();
                            }
                        ...
                        public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                            Toast.makeText(ForexActivity.this, "Gagal ambil nama mata uang", Toast.LENGTH_SHORT).show();
                        }
                    });
                } catch (JSONException e){
                    Toast.makeText(ForexActivity.this, "Gagal parsing kurs", Toast.LENGTH_SHORT).show();
                    _swipeRefreshLayout1.setRefreshing(false);
                }
            }
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                ...
                Toast.makeText(ForexActivity.this, "Gagal ambil kurs", Toast.LENGTH_SHORT).show();
                _swipeRefreshLayout1.setRefreshing(false);
            }
        });
    }
