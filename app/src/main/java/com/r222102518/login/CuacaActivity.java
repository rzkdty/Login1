...
public class CuacaActivity extends AppCompatActivity {
    ...
    private void initButtonViewCityInfo(){
        ...
        _buttonViewCityInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CuacaActivity.this, GpsActivity.class);
    ...
    private void bindRecycleView1(){
        ...
        if (namakota.isEmpty()){
            Toast.makeText(CuacaActivity.this, "Nama kota tidak boleh kosong", Toast.LENGTH_SHORT).show();
            return;
        }
        try {
        ...
        String url = "https://api.openweathermap.org/data/2.5/forecast?q=" + namakota + "&appid=7cc14e86c327c839131541a1f0c4d16c";
        Log.d("*tw*", url);
